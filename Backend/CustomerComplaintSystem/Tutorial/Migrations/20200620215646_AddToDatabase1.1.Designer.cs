...
namespace CustomerComplaintSystem.Migrations
{
    ...
    [Migration("20200620215646_AddToDatabase1.1")]
    partial class AddToDatabase11
    {
            ...
            modelBuilder.Entity("CustomerComplaintSystem.Entities.Account", b =>
                {
                    ...
                    b.HasOne("CustomerComplaintSystem.Entities.AccountType", "ParentAccountType")
                        .WithMany()
            ...
            modelBuilder.Entity("CustomerComplaintSystem.Entities.Agent", b =>
                {
                    ...
                    b.HasOne("CustomerComplaintSystem.Entities.NatureOfComplaint", "ParentNatureOfComplaint")
                        .WithMany()
